      ...
      <main className="mx-auto max-w-4xl px-6 py-24">
        ...
        <div className="grid gap-6 md:grid-cols-3 mt-7">
          ...
          <div className="card">
            ...
            <h3 className="text-lg font-semibold text-center">Polished Drafts</h3>
          ...
          <div className="card">
            ...
            <h3 className="text-lg font-semibold text-center">Actionable Docs</h3>
            <p className="mt-2 text-sm text-gray-400 text-center">
          ...
          <div className="card">
            ...
            <h3 className="text-lg font-semibold text-center">Strategic Outputs</h3>
            <p className="mt-2 text-sm text-gray-400 text-center">
